...
public class PushOrder {
	...
	public static void pushOrderToCarportUser(String cid, String phone,
			int userid, int carportId) throws Exception {
		// 配置返回每个用户返回用户状态，可选
		...
		push.connect();
		// 通知透传模板
		TransmissionTemplate template = transmissionTemplateDemo("1001-"+phone + ","
				+ userid+","+carportId);
