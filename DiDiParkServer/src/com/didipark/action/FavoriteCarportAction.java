...
public class FavoriteCarportAction extends ActionSupport implements
	...
	public void favoriteCarport() {
		JSONObject json = new JSONObject();
		if (favoriteDao.hasSaved(user_id, carport_id)==true) {
			favoriteDao.saveFavorite(user_id, carport_id);
			json.put("message", "success");
		}else{
			json.put("message", "has_save");
		}
		try {
